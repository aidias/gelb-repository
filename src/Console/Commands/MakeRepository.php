...
class MakeRepository extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gelb:make:repository
                            { repositoryName : Prefix used for all related repository files generated by the command }';
     ...
     * @var string
     */
    protected $description = 'Generate Gelb repository with an interface injection in Repository Service Provider. Eloquent repository is generated as default';
    ...
    public function handle()
    {
        if(!file_exists(app_path()."/Providers/RepositoryServiceProvider.php")) {
            $this->warn('There is no RepositoryServiceProvider in "app/Providers" folder, run: php artisan gelb:repository:init');
        } else {
